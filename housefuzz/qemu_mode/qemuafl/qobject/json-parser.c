...
static QObject *parse_literal(JSONParserContext *ctxt)
{
    ...
    switch (token->type) {
    case JSON_QEMU_STRING:
        return QOBJECT(parse_string(ctxt, token));
    case JSON_QEMU_INTEGER: {
        /*
         * Represent JSON_QEMU_INTEGER as QNUM_I64 if possible, else as
         ...
         * JSON_QEMU_INTEGER, qnum_get_uint() for any unsigned 64-bit
         * integer, and qnum_get_double() both for any JSON_QEMU_INTEGER
